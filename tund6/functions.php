<?php
	...
	function listIdeas(){
		...
		$stmt = $mysqli->prepare("SELECT id, idea, ideacolor FROM vp1userideas WHERE userid = ? ORDER BY id DESC");
		echo $mysqli->error;
		...
		while($stmt->fetch()){
			...
			//mingi komentaar koppis kuskilt...
//veel komentaar... | <a href="edituseridea.php?id=34">Toimeta</a></p>
		}
